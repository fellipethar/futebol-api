package br.com.fss.futebolapi.execption;
...
public class ResourceExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<StandardError> forbbidenException(ForbiddenException e, HttpServletRequest request) {
		return ResponseEntity.status(HttpStatus.FORBIDDEN).body(new StandardError(HttpStatus.UNAUTHORIZED, e.getMessage(), request.getRequestURI()));
	}
